...
import (
	...
	"github.com/xiaohuifirst/ccectl/client/clientset/versioned/scheme"
...
// CalicoV1Client is used to interact with features provided by the calico group.
type CalicoV1Client struct {
	restClient rest.Interface
}

func (c *CalicoV1Client) IPPools() IPPoolInterface {
	return newIPPools(c)
}
