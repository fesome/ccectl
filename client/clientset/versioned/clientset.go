...
type Clientset struct {
	*discovery.DiscoveryClient
	calicoV1 *calicov1.CalicoV1Client
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.calicoV1, err = calicov1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.calicoV1 = calicov1.NewForConfigOrDie(c)
