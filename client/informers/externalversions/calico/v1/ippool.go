...
import (
	...
	internalinterfaces "github.com/xiaohuifirst/ccectl/client/informers/externalversions/internalinterfaces"
	v1 "github.com/xiaohuifirst/ccectl/client/listers/calico/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CalicoV1().IPPools().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CalicoV1().IPPools().Watch(context.TODO(), options)
			},
		},
		&calicov1.IPPool{},
		resyncPeriod,
...
func (f *iPPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&calicov1.IPPool{}, f.defaultInformer)
}
